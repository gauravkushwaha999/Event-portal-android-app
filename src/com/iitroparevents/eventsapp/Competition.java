...
public class Competition extends Fragment {
	View competition;
	String text="Competition";
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		super.onCreateView(inflater, container, savedInstanceState);

		competition = inflater.inflate(R.layout.competition_frag, container, false);
	...
	public void update()
	{
		LinearLayout main=(LinearLayout) (competition.findViewById(R.id.main_layout));
